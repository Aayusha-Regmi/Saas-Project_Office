    ...
    <footer className="bg-[#0a1e43] text-white relative">
      <div className="container mx-auto px-4 pt-16 pb-8">
        ...
        <div className="absolute bottom-0 left-0 w-full">
          <img src="/images/img_rectangle_42130.png" alt="" className="w-full" />
          <img src="/images/img_rectangle_42131.png" alt="" className="w-full" />
        </div>
        
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Column 1 - Company Info */}
          <div>
            <img src="/images/img_saas_logo_101_1.png" alt="SAAS Logo" className="h-16 w-auto mb-6" />
