...
const Button = ({ children, onClick, variant = 'primary', size = 'medium', disabled = false, type = 'button', className = '', icon = null, ...props }) => {
  ...
  const variants = {
    primary: 'bg-[#32b5fd] text-white hover:bg-[#22a8ff] disabled:bg-gray-400',
