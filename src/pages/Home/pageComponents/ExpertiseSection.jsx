  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-4">
        ...
        <motion.p
          className="text-xl font-semibold text-gray-400 text-center max-w-2xl mx-auto mb-16"
          variants={expertiseVariants}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }}
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.3 }}
        >
          <motion.div className="md:col-span-1" variants={expertiseVariants}>
            <img
          ...
          <motion.div className="md:col-span-1" variants={expertiseVariants}>
            <div className="space-y-8">
              {benefits.map((benefit) => (
                <motion.div key={benefit.id} className="flex" variants={expertiseVariants}>
                  <div className="mr-6">
                    <img src={benefit.icon} alt={benefit.title} className="w-[62px] h-[62px]" />
                  </div>
                  <div>
