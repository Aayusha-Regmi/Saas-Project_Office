    ...
    <section className="py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
          <div className="md:col-span-1">
            <img
              src="/images/img_image_586x1440.png"
              alt="Contact"
          ...
          <motion.div
            className="md:col-span-1 bg-gray-500 p-8"
            variants={staggerContainer}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.3 }}
          >
            <motion.h2 className="text-4xl font-bold text-blue-800 text-center mb-6" variants={fadeInUp}>
              Get In Touch
            </motion.h2>
            ...
            <form onSubmit={handleSubmit}>
              <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6" variants={fadeInUp}>
                <div className="md:col-span-1">
                  <div className="bg-white rounded-3xl flex items-center p-4">
                    <img
                      src="/images/img_solaruserbold.svg"
                      alt="User"
                    ...
                    <input
                      ...
                      className="w-full bg-transparent text-blue-900 outline-none text-lg"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="md:col-span-1">
                  <div className="bg-white rounded-3xl flex items-center p-4">
                    <img
                      src="/images/img_riphonefill.svg"
                      alt="Phone"
                      className="w-6 h-6 mr-4"
                    />
                    <input
                ...
                <div className="md:col-span-1">
                  <div className="bg-white rounded-3xl flex items-center p-4">
                    <img
                      src="/images/img_materialsymbolslightservicetoolbox.svg"
                      alt="Service"
                      className="w-6 h-6 mr-4"
                    />
                    <input
              ...
              <motion.div className="mb-6" variants={fadeInUp}>
                <div className="bg-white rounded-2xl flex p-4">
                  <img
                    src="/images/img_mynauimessagedotssolid.svg"
                    alt="Message"
                  ...
                  <textarea
                    ...
                    className="w-full bg-transparent text-blue-900 outline-none text-lg min-h-[100px]"
                    required
                  ></textarea>
                </div>
              </motion.div>
